...
public class Business  {
	...
	{
		// TODO Vérifier que UserCircle est bien actualisé en mm temps
	...
	public static void SaveAMarker(String info, String title)
	{
		...
		// TODO Vérifier le marker est bien assosié a l'user qui le crée
	...
	public static void FindAFriend(HashMap<String, String> dictionary, Context context) {
		//fonction qui retourne dans processFoundFriend de main activity un ami selon le dictionary donné
		DatabaseHelper.CheckOutAFriend(dictionary, context);
	}

	public static void FindAllFriendToPrintMarkers(Context context) {
		
		// fonction qui renvoi a la fonction printMarkers du main activity les list de marker dees amis du current user pour etre printé sur la map
